...
const Pagination = ({
  ...
  const buttonBaseClasses = 
    'flex-1 flex justify-center p-2 text-2xl select-none border border-white rounded-lg transition-colors duration-200';
  ...
  return (
    <div className='flex flex-col justify-between xl:flex-row items-center gap-4'>
      <div className='text-2xl xl:text-4xl select-none cursor-default text-center xl:text-left'>
      ...
      <div className='flex flex-row gap-3 items-center'>
        ...
        <div className='flex-1 text-2xl text-nowrap text-center cursor-default min-w-[120px]'>
          {page} из {totalPage}
        </div>
